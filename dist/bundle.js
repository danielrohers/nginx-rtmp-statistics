	...
	var Form = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { type: 'button', className: 'btn btn-default', onClick: this.stop },
	        'stop'
	      )
	    );
	  }
	...
	var Rtmp = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Header, { name: 'RTMP' }),
	      React.createElement(
	        'div',
	        { className: 'col-md-6' },
	        React.createElement(Article, { label: 'Nginx version', value: this.props.rtmp.nginx_version }),
	        React.createElement(Article, { label: 'Nginx rtmp version', value: this.props.rtmp.nginx_rtmp_version }),
	...
	var Stream = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(Meta, { meta: this.props.stream.meta })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('svg', { id: this.props.id });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Meta = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'section',
	      { className: 'meta container col-md-12' },
	      React.createElement(Header, { name: 'Meta' }),
	      React.createElement(Video, { video: this.props.meta.video }),
	      React.createElement(Audio, { audio: this.props.meta.audio })
	    );
	  }
	...
	var Video = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(Header, { name: 'Video' }),
	      React.createElement(
	        'div',
	        { className: 'col-md-12' },
	        React.createElement(
	          'div',
	          { className: 'col-md-6' },
	          React.createElement(Article, { label: 'Width', value: this.props.video.width }),
	          React.createElement(Article, { label: 'Height', value: this.props.video.height }),
	          React.createElement(Article, { label: 'Frame rate', value: this.props.video.frame_rate }),
	          React.createElement(Article, { label: 'Codec', value: this.props.video.codec })
	        ),
	        React.createElement(
	          'div',
	          { className: 'col-md-6' },
	          React.createElement(Article, { label: 'Profile', value: this.props.video.profile }),
	          React.createElement(Article, { label: 'Compat', value: this.props.video.compat }),
	          React.createElement(Article, { label: 'Level', value: this.props.video.level })
	        )
	      )
	    );
	  }
	...
	var Audio = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'article',
	      { className: 'col-md-12' },
	      React.createElement(Header, { name: 'Audio' }),
	      React.createElement(
	        'div',
	        { className: 'col-md-12' },
	        React.createElement(
	          'div',
	          { className: 'col-md-6' },
	          React.createElement(Article, { label: 'Channels', value: this.props.audio.channels }),
	          React.createElement(Article, { label: 'Codec', value: this.props.audio.codec })
	        ),
	        React.createElement(
	          'div',
	          { className: 'col-md-6' },
	          React.createElement(Article, { label: 'Sample rate', value: this.props.audio.sample_rate })
	        )
	      )
	    );
	  }
